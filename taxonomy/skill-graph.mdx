...
<CardGroup cols={2}>
  ...
  <Card title="get_correlations" icon="share-nodes">
    Returns the Hebbian correlation neighbors of a named skill — other skills that are frequently activated together with it. Useful for surfacing related context the agent might not have explicitly requested.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="memory.recall MCP plugin" icon="tool" href="/developer/mcp/memory-recall">
    Full reference for activate_skills, get_skill, find_skills, get_correlations
  </Card>
</CardGroup>
